...
import HeatExchangerSvg from '../../assets/ADFP SVG/S&T Exchanger V2.svg';
...
export const svgMap = {
  ...
  "coupling-node": CouplingNodeSvg,
  "compressor-node": CompressorNodeSvg,
  "compressor-config-node": CompressorConfigSvg,
  "box-node": BoxNodeSvg,
  "heat-exchanger-node": HeatExchangerSvg,
  "turbine-node": TurbineNodeSvg,
  "surface-condenser-node": SurfaceCondenserSvg,
  "kod-node": KODSvg,
  "centrifugal-pump-node": CentrifugalPumpSvg,
  "esv-node": ESVSvg,
